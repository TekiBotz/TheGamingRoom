...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		// Create Jersey client instance using JerseyClientBuilder and give it an Environment reference
		Client DemoRESTClient = new JerseyClientBuilder(e).build("DemoRESTClient");
